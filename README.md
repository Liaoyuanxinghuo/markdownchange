...
将Markdown文件中的本地图片转换为Base64编码，使Markdown文件可以独立使用，无需额外图片文件，也可以把Base64编码的图片转换为本地图片,然后变成引用。
...
- 忽略网络图片链接
- 转换后的文件自动命名为 `原文件名-base64.md`或`原文件名-ref.md`
- 简洁美观的图形化界面
...
- 转换后的文件会自动命名为 `原文件名-base64.md`或`原文件名-ref.md`
- 网络图片链接不会被转换
- 原始文件不会被修改
